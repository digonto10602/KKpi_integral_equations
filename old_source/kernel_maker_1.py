...
def print_contour_files(opefile,qvecfile,pcutfile,thresholdfile,opecuttracerfile,scount,N):
    ...
    ax[0].set_title(fig1_str,fontsize=20)
    ...
    ax[0].set_xlabel("Re $p$",fontsize=20)
    ax[0].set_ylabel("Im $p$",fontsize=20)
    ...
    ax[0].contour(Xi, Yi, zi,levels=np.linspace(-100,100,num=500), linewidths=0.5, colors='k',linestyles='solid')
    h0 = ax[0].contourf(Xi, Yi, zi,levels=np.linspace(-20,20,num=20))
    ...
    ax[0].plot(qvecx,qvecy,linestyle="solid",linewidth=2,color="yellow")
    ax[0].plot(reMbcrightplus,imMbcrightplus, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="orange")
    ax[0].plot(reMbcrightminus,imMbcrightminus, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="orange")
    ax[0].plot(req,imq, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="darkviolet", label="$q$")
    ax[0].plot(-req,-imq, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="darkviolet", label="$q$")
    ...
    ax[0].plot(pcutpR1,pcutpI1,linestyle="solid",linewidth=2,color="red")
    ax[0].plot(pcutmR1,pcutmI1,linestyle="solid",linewidth=2,color="blue")
    ax[0].plot(reqplusplus1,imqplusplus1, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="red",label="$q_+$")
    ax[0].plot(reqplusminus1,imqplusminus1, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="red",label="$q_+$")
    ax[0].plot(reqminusplus1,imqminusplus1, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="blue",label="$q_+$")
    ax[0].plot(reqminusminus1,imqminusminus1, marker="o", markersize=10, markeredgecolor="black", markerfacecolor="blue",label="$q_+$")
